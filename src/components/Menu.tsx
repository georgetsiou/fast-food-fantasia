...
import { ExternalLink, ShoppingBag, Utensils, Coffee, Pizza, Salad, Beef, Sandwich, Beer, AlignJustify } from 'lucide-react';
...
const menuItems = [
  ...
  {
    category: "Burgers",
    icon: <AlignJustify className="text-pumba-red" size={24} />,
    items: [
      {
      ...
      },
      {
        ...
        description: "Ψωμάκι brioche με μπιφτέκι λαχανικών,
