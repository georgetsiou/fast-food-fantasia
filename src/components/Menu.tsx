      ...
      <div className="container mx-auto">
        <div className="max-w-5xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 gap-8">
            {menuItems.map((category, idx) => <div key={idx} className="reveal">
                <h3 className="text-2xl font-bold mb-4 text-pumba-red">{category.category}</h3>
                <div className="space-y-6">
                  {category.items.map((item, itemIdx) => <div key={itemIdx} className={`menu-item rounded-lg overflow-hidden bg-gray-900/50 hover:bg-gray-800/50 transition-all duration-300 ${item.featured ? 'border border-pumba-red' : 'border border-transparent'}`}>
